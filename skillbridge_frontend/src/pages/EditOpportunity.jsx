...
const EditOpportunity = () => {
    ...
    if (loading) return <div style={{ display: "flex", minHeight: "100vh", background: "#f5f7fa" }}><Sidebar /><div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>Loading...</div></div>;
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ padding: "32px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "24px" }}>
                        ...
                        <h2 style={{ fontSize: "24px", fontWeight: "700", color: "#111827", margin: 0 }}>Edit Opportunity</h2>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} style={{ background: "white", padding: "30px", borderRadius: "12px", border: "1px solid #e5e7eb", maxWidth: "650px" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "flex-end", gap: "12px" }}>
                            ...
                            <button type="submit" style={{
                                ...
                                background: "#16a34a", color: "white", fontSize: "14px", fontWeight: "600", cursor: "pointer"
                            }}>Save Changes</button>
                        </div>
                    </form>
                </div>
